...
}if(d.ajaxBinding){b().waitingpopup("unbindToAjax");
b().waitingpopup("bindToAjax")
}},bindToAjax:function(){b("#waiting_popup").bind("ajaxStart",function(){b().waitingpopup("open")
});
b("#waiting_popup").bind("ajaxStop",function(){b().waitingpopup("close")
})
},unbindToAjax:function(){b("#waiting_popup").unbind("ajaxStart");
b("#waiting_popup").unbind("ajaxStop")
